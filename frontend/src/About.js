      ...
      <div className="about-container">
        ...
        <div className="about-grid">
          <div className="about-card">
            ...
            <h3 className='aboutcardh3'>Innovation</h3>
            <p className='about-small-card'>Stay ahead with a curriculum updated weekly to reflect the latest tech trends.</p>
          </div>
          ...
          <div className="about-card">
            ...
            <h3 className='aboutcardh3'>Expert Mentors</h3>
            <p className='about-small-card'>Learn directly from professionals currently working in top-tier tech companies.</p>
          </div>
          ...
          <div className="about-card">
            ...
            <h3 className='aboutcardh3'>Community</h3>
            <p className='about-small-card'>Join a network of over 5,000+ students and alumni helping each other grow.</p>
          </div>
          ...
          <div className="about-card">
            ...
            <h3 className='aboutcardh3'>Certification</h3>
            <p className='about-small-card'>Earn industry-recognized certificates that give you a competitive edge.</p>
          </div>
        </div>
